<div id="footerTab">
        <div id="address">
            ...
            <div id="addressContainer">
                <ul>
                    <li class="address">241 Quốc lộ 1K, Linh Xuân, Thủ Đức, Thành phố Hồ Chí Minh</li>
                    <li class="address">30 Đ. Tân Thắng, Sơn Kỳ, Tân Phú, Thành phố Hồ Chí Minh</li>
                </ul>
            </div>
        </div>
        <div id="socialMedia">
        ...
        <div id="contact">
            ...
            <div class="contactsContainer">
                <div class="contactContainer">
                    ...
                    <div class="contactInfo">mentalfirstvn@gmail.com</div>
                </div>
                <div class="contactContainer">
                    <div class="contactTitle">Hotline</div>
                    <div class="contactInfo">0727 727 727</div>
                </div>
            </div>
        </div>
    </div>
